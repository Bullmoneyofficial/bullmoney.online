...
const getDeviceTier = (forceLoad = false) => {
  ...
  // UPDATED 2026: All devices default to high tier for premium experience
  // Hero MUST load on all devices - no browser blocking
  if (forceLoad) {
    return 'high'; // Always high quality
  }
...
export default function SplineWrapper({ 
  ...
  return (
    ...
    >
      ...
      {/* 3D CANVAS - Touch-action pan-y allows scrolling while enabling interaction */}
      ...
      <canvas
        ...
        style={{ 
          ...
          maxHeight: '100%',
          objectFit: 'contain',
          touchAction: 'pan-y', // Allow vertical scroll while still interactive
          pointerEvents: 'auto', // Interactive on all devices
