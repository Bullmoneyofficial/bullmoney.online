...
const BottomControls = ({ 
    ...
    return (
        <div 
            ...
            // We do NOT apply the filter to the wrapper, or it might move/distort positioning.
            // instead we apply it to the inner visual elements.
            style={{ 
                opacity: visible ? 1 : 0,
        ...
        >
            ...
            {/* MAIN WIDGET PILL - THEME FILTER APPLIED HERE */}
            <div 
                ...
                style={{ filter: theme.filter, WebkitFilter: theme.filter }} // DYNAMIC THEME APPLICATION
            >
                <button
            ...
            {/* NOW STREAMING TEXT - THEME FILTER APPLIED HERE */}
            <div 
    ...
    <BlogProvider>
      ...
      <div className="fixed inset-0 z-[400000] pointer-events-none">
          <BottomControls 
              ...
              theme={activeTheme} // PASSING THEME
          />
          {/* PASSING THEME TO SUPPORT WIDGET */}
      ...
      <div className="relative w-full min-h-screen" onClick={safePlay}>
        ...
        {currentStage === "register" && (
            <div 
                className="fixed inset-0 z-[100000] bg-slate-950 text-white transition-all duration-500"
                style={{ filter: activeTheme.filter, WebkitFilter: activeTheme.filter, transform: 'translateZ(0)' }}
            >
                {/* @ts-ignore */}
        ...
        {currentStage === "hold" && (
            ...
            >
                {/* @ts-ignore */}
                <BullMoneyGate onUnlock={handleHoldComplete} theme={activeTheme}><div className="hidden" /></BullMoneyGate>
            </div>
        )}
        ...
        <div className={currentStage === 'content' ? 'profit-reveal' : 'opacity-0 pointer-events-none h-0 overflow-hidden'}>
            ...
            <main className="relative pt-20 z-10">
                <TargetCursor hideDefaultCursor={true} spinDuration={2} targetSelector="button, a, input, [role='button'], .cursor-target" />
                <Socials />
                <ShopProvider>
