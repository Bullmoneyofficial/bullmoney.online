...
import { useShop } from "../../app/VIP/ShopContext";
...
export default function AdminLoginModal({ open, onClose }: Props) {
  const { state, login, logout } = useShop();
      ...
      {open && (
        ...
        >
          <motion.div
            ...
            className="w-full max-w-md mx-4 rounded-3xl overflow-hidden border border-sky-500/40 bg-gradient-to-b from-slate-900 via-slate-950 to-black shadow-[0_0_45px_rgba(56,189,248,0.45)] p-[1px]"
          >
            <div className="rounded-3xl bg-slate-950 py-6 px-5 sm:px-7">
              ...
              <p className="text-xs text-slate-400 mb-5">
                This panel is only for BullMoney FX staff. Customers do not need
                this step to shop.
              </p>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-center justify-between pt-2">
                  ...
                  <button
                    type="submit"
                    className="text-xs px-5 py-2 rounded-full bg-gradient-to-r from-sky-400 to-indigo-500 font-semibold shadow-[0_0_25px_rgba(56,189,248,0.45)]"
                  >
