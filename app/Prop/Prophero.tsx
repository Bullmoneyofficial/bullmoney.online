      ...
      <div className="relative z-10 w-full">
        <ContainerScroll
          titleComponent={
            <>
              ...
              >
                Discover the best prop trading firms and funded trading
        ...
        >
          ...
          <div ref={containerRef} className="h-full w-full relative">
            <Image
              src="https://ftmo.com/wp-content/uploads/2024/06/graph1-mobile-1.webp"
              alt="header"
              fill
...
// --- Background and Collision Components (Unchanged) ---
