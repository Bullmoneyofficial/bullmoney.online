 ...
 *
 * Full-screen store hero — background media + CTA buttons.
 * Receives all hero state + action callbacks as props from StorePageClient.
 */
...
import { StoreHeroMedia } from '../_components/StoreHeroMedia';
...
interface StoreHeroSectionProps {
  ...
  resolvedHeroSlide: HeroSlide;
  allowHeavyHeroReady: boolean;
  shouldShowHeroMapOverlay: boolean;
  paddingBoost: number;
  onVideoEnded: () => void;
  onOpenVip: () => void;
  onVisitShop: () => void;
    ...
    >
      <div className="relative min-h-screen w-full overflow-x-hidden overflow-y-visible">
        ...
        <div
          ...
          style={{
            paddingTop: 48 + paddingBoost,
            paddingBottom: 40 + paddingBoost,
            touchAction: 'pan-y',
          }}
        >
          <div
          ...
          <div className="mt-6 flex flex-wrap items-center gap-3 pointer-events-auto sm:flex-row lg:flex-col lg:items-start lg:w-full">
            ...
            <button
              ...
              style={{
                background:
                  'linear-gradient(135deg, rgba(41, 151, 255, 0.2), rgba(41, 151, 255, 0.1))',
