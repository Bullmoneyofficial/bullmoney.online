 ...
 *
 * Social network embedded posts carousel — fetches live accounts from /api/network
 * and cycles through embedded posts (Instagram / TikTok / YouTube).
 */
...
export function StoreNetworkShowcase() {
  ...
  useEffect(() => { if (postIndex >= visiblePosts.length) setPostIndex(0); }, [postIndex, visiblePosts.length]);
