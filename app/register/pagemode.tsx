  ...
  return (
    <div className="fixed inset-0 z-[60] pointer-events-none"> 
      ...
      <motion.div 
        ...
        className="fixed w-32 h-32 rounded-full bg-blue-600/30 blur-[40px] -translate-x-1/2 -translate-y-1/2 mix-blend-screen"
      />
      {/* Trail 2 (Middle - Solid plasma body) */}
      <motion.div 
        style={{ left: x2, top: y2 }}
        className="fixed w-12 h-12 rounded-full bg-blue-400/50 blur-[12px] -translate-x-1/2 -translate-y-1/2 mix-blend-screen"
      />
      {/* Head (Core - Intense white hot center) */}
      <motion.div 
        style={{ left: x, top: y }}
        className="fixed w-4 h-4 rounded-full bg-cyan-100 shadow-[0_0_40px_rgba(34,211,238,1)] -translate-x-1/2 -translate-y-1/2 z-10"
      />
    </div>
  );
};
        ...
        >
          ...
          <div className="absolute inset-0 bg-[#010309]">
              ...
              <motion.div 
                ...
                className="absolute -top-[50%] -left-[50%] w-[200%] h-[200%] bg-[radial-gradient(circle_at_center,_rgba(23,37,84,0.15)_0%,_transparent_50%)] blur-[120px]" 
              />
              <motion.div 
                animate={{ rotate: -360, scale: [1, 1.2, 1] }} 
                transition={{ duration: 25, repeat: Infinity, ease: "linear" }}
                className="absolute -bottom-[50%] -right-[50%] w-[200%] h-[200%] bg-[radial-gradient(circle_at_center,_rgba(30,27,75,0.1)_0%,_transparent_50%)] blur-[120px]" 
              />
          </div>
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full max-w-md px-4 pointer-events-none">
            ...
            <div className="relative w-48 h-48 mb-16 flex items-center justify-center perspective-[1000px]">
              ...
              <motion.div
                ...
                className="absolute inset-0 rounded-full border-[3px] border-dashed border-blue-900/40 shadow-[0_0_20px_rgba(30,58,138,0.2)]"
              ...
              <motion.div
                ...
                className="absolute inset-4 rounded-full border-[3px] border-dashed border-indigo-900/40 shadow-[0_0_20px_rgba(49,46,129,0.2)]"
                style={{ transformStyle: 'preserve-3d' }}
              />
              ...
              <svg className="absolute inset-0 w-full h-full -rotate-90 pointer-events-none z-10 overflow-visible" viewBox="0 0 160 160">
                ...
                {/* Glow Trail */}
                 <motion.circle
                  cx="80" cy="80" r="70"
                  className="stroke-blue-600/30 stroke-[8] fill-none blur-[12px]"
            ...
            <div className="flex flex-col items-center space-y-6 w-full">
              ...
              <div className="relative">
                ...
                <h1 className="text-5xl font-black text-blue-50 tracking-tighter relative z-10 text-shadow-[0_0_7px_#1e3a8a,0_0_15px_#1e3a8a,0_0_35px_#172554,0_0_60px_#172554]">
                    BULLMONEY FREE
                </h1>
              ...
              <div className="w-full max-w-[280px] flex flex-col items-center justify-center relative p-4 bg-blue-950/10 rounded-xl border border-blue-800/30 backdrop-blur-md overflow-hidden">
                ...
                <motion.div 
                  key={progress}
                  className="text-3xl font-mono font-bold text-blue-400 mb-2 tabular-nums tracking-widest drop-shadow-[0_0_10px_rgba(59,130,246,0.5)]"
                >
