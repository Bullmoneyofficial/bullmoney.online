...
export default function BullcasinoShell({ children }: { children: ReactNode }) {
  ...
  const isGameDetailPage = useMemo(
    () => /^\/games\/[^/]+$/.test(pathname || ''),
    [pathname]
  );
  const absoluteHref = (path: string) => path;
      ...
      {!isGameDetailPage && (
        <div className="mobile_menu">
          <div className="mobile_menu__content">
            <Link href={absoluteHref('/games')} className="mobile_menu__link">
              <i className='bx bxs-home'></i>
              Home
            </Link>
            <Link href={absoluteHref('/games/terms')} className="mobile_menu__link">
            ...
            <Link href={absoluteHref('/contact')} className="mobile_menu__link">
      ...
      <div className="main__content" style={{ flex: '1 1 auto', display: 'flex', flexDirection: 'column' }}>
        ...
        <footer className="footer" style={{ marginTop: 'auto' }}>
          ...
          <div className="footer__bottom">
            <Link href={absoluteHref('/games/terms')} className="footer__rules">Terms of Use</Link>
            <Link href={absoluteHref('/privacy')} className="footer__privacy">Privacy Policy</Link>
          </div>
        </footer>
      </div>
    </main>
