"use client";  // Keep this to mark the component as a Client Component
...
const TargetCursor: React.FC<TargetCursorProps> = ({
  // Automatically targets buttons, links, and inputs
  ...
  return (
    // INLINE STYLES: pointerEvents: 'none' ensures clicks pass through the cursor
    <div 
      ref={cursorRef} 
