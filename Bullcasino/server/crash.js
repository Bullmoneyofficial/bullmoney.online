...
exports.startTimer = async function() {
...
exports.getFrame = function(float) {
...
exports.request = function(path, body) {
    return new Promise((response, reject) => {
        requestify.post('http://127.0.0.1:8000/api/' + path, body || {})
        .then((res) => {
            try {
                return response(JSON.parse(res.body));
            } catch (parseErr) {
                console.log('[API] JSON parse error for /api/' + path + ':', parseErr.message);
                console.log('[API] Raw body:', typeof res.body, res.body);
...
exports.log = function(log) { console.log('[CRASH] ' + log); }

exports.emit = function(json) { RedisClient.publish('crash', JSON.stringify(json)); }
