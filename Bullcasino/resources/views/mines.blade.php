    ...
    <div class="games__area">
        <div class="games__sidebar">
            ...
            <div class="games__input_wrapper_bombs">
                <label class="games__sidebar_label">Number of bombs</label>
                <div class="games__sidebar_wrapper_input">
            ...
            <div class="games__sidebar_play_button">
                <button class="sidebar__play">Play</button>
                <button class="sidebar__take_win" style="display: none;">Cash out <span id="win"></span>₽</button>
            </div>
        </div>
