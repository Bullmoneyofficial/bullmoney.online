...
<div class="settings__inner">
    <div class="settings__site">
        <p class="settings__head">General Site Settings</p>
            ...
            <div class="settings__inputs">
                ...
                <div class="settings__input">
                    ...
                    <select class="select__setting" name="tech" required>
                        <option value="0" @if($settings->tech_work == 0) selected @endif>No</option>
                        <option value="1" @if($settings->tech_work == 1) selected @endif>Yes</option>
                    </select>
                </div>
            </div>
            <button type="submit" class="save__settings">Save</button>
        </form>
    </div>
    <div class="settings__games">
        <p class="settings__head">Game Mode Settings</p>
        <div class="setting__game">
            <div class="setting__game_name">DICE</div>
            <div class="game__toggle dice_enabled">
                <label class="game__toggle_btn game__toggle_dice @if($settings->dice_enabled == 1) active @else no_active @endif">
        ...
        <div class="setting__game">
            ...
            <div class="game__toggle mines_enabled">
                <label class="game__toggle_btn game__toggle_mines @if($settings->mines_enabled == 1) active @else no_active @endif">
                    <input disabled="" type="checkbox">
                    <span class="toggle__switch_game"></span>
                </label>
            </div>
        ...
        <div class="setting__game">
            ...
            <div class="game__toggle wheel_enabled">
                <label class="game__toggle_btn game__toggle_wheel @if($settings->wheel_enabled == 1) active @else no_active @endif">
                    <input disabled="" type="checkbox">
                    <span class="toggle__switch_game"></span>
                </label>
            </div>
        ...
        <div class="setting__game">
            ...
            <div class="game__toggle jackpot_enabled">
                <label class="game__toggle_btn game__toggle_jackpot @if($settings->jackpot_enabled == 1) active @else no_active @endif">
                    <input disabled="" type="checkbox">
                    <span class="toggle__switch_game"></span>
                </label>
            </div>
    ...
    <div class="reboot__games">
        <p class="settings__head">Restart Modes</p>
