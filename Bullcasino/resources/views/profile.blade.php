...
<div class="profile__container">
    <div class="profile__wrapper">
        <div class="profile__header">
            <div class="profile__name">My Account</div>
            <a href="/logout" class="profile__logout">Logout</a>
        </div>
        <div class="profile__block_info">
            <div class="profile__block profile__block_balance">
                <div class="profile__title_block">My Balance</div>
                ...
                <div class="profile__user_rank">
                    ...
                    <div class="profile__progress_rank">
                        <div class="pay__progress">
                            ...
                            <div class="progress__fill" style="width: {{$max_pays > 0 ? $user_pays * 100 / $max_pays : 0}}%"></div>
                        </div>
                    </div>
            ...
            <div class="profile__block profile__block_social">
                <div class="profile__title_block">My Connections</div>
        ...
        <div class="profile__user">
            <div class="profile__personal_info">
                <div class="profile__user_info">
                    <img src="{{Auth::user()->avatar}}" alt="Avatar" class="profile__avatar">
