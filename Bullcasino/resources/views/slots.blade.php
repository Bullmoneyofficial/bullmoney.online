...
<div class="wrapper" style="width:100%">
	...
	<div class="headSlots">
		...
		<button class="btnSlots" style="background:linear-gradient(135deg, #007AFF 0%, #5AC8FA 100%)" data-color="#fff" data-opacity="0.1" data-duration="0.3" onclick="toggleProviders()" style="pointer-events: auto;">
			Providers
		...
		<div style="display: flex;justify-content: space-between;align-items: center;">
			<div style="float: left;">
				<div class="slotsLeftBox">
					...
					<span id="nameSlotsBox" style="color:#1D1D1F"></span>
				</div>
			</div>
...
">
	...
	<script type="text/javascript">
		...
		function notFound() {
		    return `<div class="slots--notFound">Nothing found</div>`
		}
