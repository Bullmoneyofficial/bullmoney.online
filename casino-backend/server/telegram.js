...
bot.on('message', async msg => {
    ...
    if(text.toLowerCase() === '/start') {
        return bot.sendMessage(chat_id, `This is the official BullMoney Telegram bot. To link your Telegram account, enter the command shown at <a href="https://bullmoney.shop/bonus">bullmoney.shop/bonus</a>.`, {
            parse_mode: "HTML",
