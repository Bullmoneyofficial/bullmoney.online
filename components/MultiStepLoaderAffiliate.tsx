...
// --- 3. TRADINGVIEW CHART BACKGROUND (Affiliate Edition) ---
const TradingViewBackground = memo(({ assetKey }: { assetKey: AssetKey }) => {
  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      <div className="absolute inset-0 bg-[#0c0a09]/30 z-10 mix-blend-overlay" />
      <div
        ref={containerRef}
...
// --- 4. INTERACTIVE HEADER WITH SHIMMER ---
  ...
  return (
    ...
    >
            ...
            >
              ...
              <div className="flex flex-col items-start z-10">
                <span className={cn(
                  ...
                  isActive ? "animate-text-shimmer-affiliate" : "text-neutral-500"
                )}>
                  {asset.name}
                </span>
                {isActive && (
      ...
      <div className="flex flex-col items-end">
        <div
          className="text-2xl md:text-3xl font-mono font-black tracking-tight leading-none tabular-nums animate-text-shimmer-affiliate"
        >
  ...
  return (
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          {/* Custom CSS for Affiliate Shimmer */}
          <style jsx global>{`
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(55,48,163,0.3)_0%,#030712_100%)] z-10 pointer-events-none" />
          ...
          <div className="relative z-20 flex flex-col items-center justify-center p-4 w-full h-full pb-24 md:pb-32 pointer-events-none">
            ...
            <div className="mb-4 md:mb-6 relative z-50 pointer-events-auto">
            ...
            <div className="relative w-full max-w-[400px] flex flex-col items-center justify-center">
              ...
              <div className="relative z-30 flex flex-col items-center mb-6">
                <div className="text-6xl md:text-8xl font-mono font-bold mb-2 tabular-nums tracking-tighter animate-text-shimmer-affiliate">
