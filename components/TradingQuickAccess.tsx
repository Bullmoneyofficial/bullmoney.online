        ...
        <>
          ...
          >
            ...
            >
              ...
              {/* Custom Discord Live Stage UI - No widget required */}
              <div className="relative w-full h-[280px] sm:h-[350px] md:h-[400px] flex flex-col items-center justify-center p-4 sm:p-6 bg-gradient-to-b from-purple-900/20 to-zinc-900/40">
                ...
                >
                  ...
                  />
                  <svg className="w-16 h-16 sm:w-20 sm:h-20 text-white relative z-10" viewBox="0 0 24 24" fill="currentColor">
                ...
                <motion.p
                  ...
                  className="text-purple-200/70 text-xs sm:text-sm text-center mb-6 max-w-[280px]"
                >
                  Join our live trading discussions, market analysis, and real-time calls
                </motion.p>
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.95 }}
                  className="px-6 py-3 bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-500 hover:to-purple-400 text-white font-bold rounded-full shadow-lg shadow-purple-900/50 flex items-center gap-2 transition-all"
                >
                ...
                <motion.a
                  ...
                  className="mt-3 text-purple-400/60 hover:text-purple-300 text-xs underline underline-offset-2 transition-colors"
                >
                  Open Stage Channel Directly
                </motion.a>
              </div>
            </div>
          </motion.div>
