          ...
          <div className="flex items-center gap-4 md:order-3">
              <Link href={instagramUrl} target="_blank" rel="noopener noreferrer">
                  <motion.div
                    ...
                    className="p-3 rounded-full bg-neutral-100 dark:bg-neutral-800 text-neutral-600 dark:text-neutral-300 hover:text-#3b82f6 dark:hover:text-#60a5fa transition-colors cursor-pointer"
                  >
                      <FaInstagram size={24} />
                  </motion.div>
              </Link>
