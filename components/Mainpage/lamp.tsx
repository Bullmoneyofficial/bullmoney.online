    ...
    >
      <div className="absolute inset-0">
        <motion.div
          ...
          style={{ backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))` }}
          className="absolute left-1/2 top-1/2 h-40 -translate-x-[60%] -translate-y-1/2 bg-gradient-conic from-white via-transparent to-transparent [--conic-position:from_70deg_at_center_top]"
        />
        <motion.div
          initial={{ opacity: 0.5, width: "10rem" }}
          whileInView={{ opacity: 1, width: "18rem" }}
          transition={{ delay: 0.1, duration: 0.6, ease: "easeInOut" }}
          style={{ backgroundImage: `conic-gradient(var(--conic-position), var(--tw-gradient-stops))` }}
          className="absolute left-1/2 top-1/2 h-40 translate-x-[10%] -translate-y-1/2 bg-gradient-conic from-transparent via-transparent to-white [--conic-position:from_290deg_at_center_top]"
        />
        <div className="absolute left-1/2 top-1/2 h-28 w-56 -translate-x-1/2 -translate-y-[55%] rounded-full bg-white/30 blur-2xl" />
