  ...
  return (
    <main className="px-4 md:px-6">
      ...
      >
        ...
        <div className="pointer-events-none absolute -top-12 right-0 h-24 w-2/3 bg-linear-to-l from-white/20 via-white/15 to-white/0 blur-2xl z-0" />
        ...
        <div className="relative z-10">
          ...
          <motion.header {...fade} className="flex items-center justify-between gap-6">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl md:text-4xl font-black bg-linear-to-r from-white via-white to-white bg-clip-text text-transparent">
                About Us
              </h1>
            </div>
          ...
          {/* Divider */}
          <div className="my-8 h-px w-full bg-linear-to-r from-white/20 via-white/20 to-white/20" />
          ...
          {/* CTA / Footer */}
          <div className="mt-8 h-px w-full bg-linear-to-r from-white/20 via-white/20 to-white/20" />
          <footer className="mt-6 flex items-center justify-between">
            ...
            <span className="text-sm bg-linear-to-r from-white via-white to-white bg-clip-text text-transparent font-semibold">
              • • •
            </span>
          </footer>
        </div>
