...
if (!supabaseUrl || !supabaseKey) {
  throw new Error("Missing Supabase keys in .env.local file");
}
      ...
      <div className={cn(
              ...
              >
                ...
                >
                  ...
                  <motion.div
                    ...
                    className="w-full max-w-52 rounded-xl p-4 sm:max-w-xs sm:rounded-2xl sm:p-7 border border-white/8"
                    style={{
                  ...
                  >
                    ...
                    <div className="flex flex-col gap-2 sm:gap-3">
                      ...
                      <div className="flex items-center gap-2 sm:gap-3 my-1 sm:my-2">
                        <div className="flex-1 h-0.12 bg-white/8" />
            ...
            >
              ...
              >
                <motion.div
                  ...
                  className="rounded-2xl p-8 text-center w-full max-w-sm border border-white/8"
                  style={{
                    background: 'rgba(0, 0, 0, 0.4)',
                    backdropFilter: shouldDisableBackdropBlur ? 'none' : 'blur(40px)',
                    WebkitBackdropFilter: shouldDisableBackdropBlur ? 'none' : 'blur(40px)',
        ...
        {step !== -1 && step !== -2 && viewMode === 'login' ? (
          ...
          >
             ...
             <div className="bg-black/40 p-8 md:p-10 rounded-2xl relative overflow-hidden w-full max-w-md mx-4 border border-white/8" style={{ backdropFilter: shouldDisableBackdropBlur ? 'none' : 'blur(40px)', WebkitBackdropFilter: shouldDisableBackdropBlur ? 'none' : 'blur(40px)', boxShadow: '0 0 1px rgba(255, 255, 255, 0.1)' }}>
                ...
                <form onSubmit={handleLoginSubmit} className="space-y-4 relative z-10" autoComplete="on">
                   <div className="relative group">
                      <input
                        ...
                        placeholder="Email"
                        className="w-full bg-white/3 border border-white/8 rounded-xl px-4 py-4 text-white! transition-all focus:outline-none focus:border-white/20 text-base placeholder-white/30"
                        style={{ color: '#ffffff' }}
                      />
                    </div>
                   ...
                   <div className="relative group">
                      <input
                        ...
                        className="w-full bg-white/3 border border-white/8 rounded-xl px-4 py-4 pr-12 text-white! transition-all focus:outline-none focus:border-white/20 text-base placeholder-white/30"
                        style={{ color: '#ffffff' }}
                      />
                      <button
                        type="button"
              ...
              {step === 1 && (
                ...
                >
                  <StepCard
                    ...
                    className="bg-black/40 register-card w-full max-w-md mx-auto border border-white/8"
                    isXM={isXM}
                    disableEffects={true}
                  ...
                  >
                    ...
                    {/* VISUAL ELEMENT (CARD) */}
                    <div className={cn(
                      "relative mx-auto w-full max-w-60 md:max-w-70 h-28 md:h-40 rounded-3xl overflow-visible mb-2 opacity-80 hover:opacity-100 transition-opacity",
                      neonBorderClass
              ...
              {step === 3 && (
                ...
                >
                  <StepCard
                    ...
                    className="register-card w-full max-w-md mx-auto bg-black/40 border border-white/8"
                    isXM={isXM}
                    disableEffects={true}
                    disableBackdropBlur={shouldDisableBackdropBlur}
                    actions={
                  ...
                  >
                    ...
                    <div className="space-y-4 md:space-y-4 pt-1">
                      <div>
                        <div className="relative group">
                          <input
                            ...
                            className="w-full bg-white/3 border border-white/8 rounded-xl px-4 py-4 text-white! transition-all cursor-target text-base placeholder-white/30 focus:outline-none focus:border-white/20"
                            style={{ color: '#ffffff' }}
                          />
                        </div>
                      ...
                      <div>
                        <div className="relative group">
                          <input
                            ...
                            className="w-full bg-white/3 border border-white/8 rounded-xl px-4 pr-12 py-4 text-white! transition-all cursor-target text-base placeholder-white/30 focus:outline-none focus:border-white/20"
                            style={{ color: '#ffffff' }}
                          />
                          <button
                            type="button"
                      ...
                      <div>
                        ...
                        className="flex items-start gap-3 p-4 rounded-xl bg-white/2 cursor-pointer transition-colors cursor-target border border-white/5"
                      >
                        <div
                          onClick={() => setAcceptedTerms(!acceptedTerms)}
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-center justify-between mb-6 md:mb-8 relative z-10">
        <span className="inline-flex items-center gap-2 text-[10px] md:text-[11px] uppercase tracking-wider px-3 py-1.5 rounded-full bg-white/3 border border-white/8 text-white/40 font-normal">
          Step {n} of 3
        </span>
      </div>
      ...
      {actions && <div className="mt-6 md:mt-8 pt-6 md:pt-8 border-t border-white/8 relative z-10">{actions}</div>}
    </div>
  );
});
  ...
  return (
    <div className="pointer-events-none absolute inset-0">
      ...
      <motion.div className="absolute inset-0 opacity-20 mix-blend-screen group-hover/card:opacity-60" style={style}>
        <p className="absolute inset-x-0 p-2 text-[10px] leading-4 h-full whitespace-pre-wrap wrap-break-word font-mono font-bold transition duration-500"
           style={{
             color: '#fca5a5',
