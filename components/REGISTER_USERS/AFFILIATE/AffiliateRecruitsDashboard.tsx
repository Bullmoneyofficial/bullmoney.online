  ...
  return (
    <div className="min-h-screen bg-[#050B14] text-white font-sans selection:bg-white/30">
      ...
      <div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-[-10%] right-[-10%] w-125 h-125 bg-white/10 rounded-full blur-[120px]" />
      </div>
                ...
                {loading && recruits.length === 0 ? (
                  ...
                  filteredRecruits.map((recruit) => (
                    <motion.tr
                        ...
                        className="group hover:bg-white/5 transition-colors cursor-pointer active:bg-white/8"
                    >
...
[Image of affiliate marketing customer journey map]
                        ...
                        <div className="relative pl-4 space-y-8 border-l border-white/10 ml-2">
                            ...
                            <div className="relative">
                                <div className="absolute -left-5.25 top-1 w-3 h-3 rounded-full bg-white shadow-[0_0_10px_rgba(255,255,255,0.5)]" />
                            ...
                            <div className="relative">
                                <div className={cn(
                                    "absolute -left-5.25 top-1 w-3 h-3 rounded-full shadow-[0_0_10px_rgba(255,255,255,0.5)]",
                            ...
                            <div className="relative">
                                <div className={cn(
                                    "absolute -left-5.25 top-1 w-3 h-3 rounded-full",
