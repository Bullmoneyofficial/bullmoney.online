...
const useLivePrice = (assetKey: AssetKey) => {
  ...
  useEffect(() => {
    ...
    try {
      ...
      ws.onerror = () => {
        // Silent fail on WebSocket error
        const fallbackPrices: Record<AssetKey, number> = {
          BTC: 67500,
          ETH: 3450,
          SOL: 145,
...
const TradingViewBackground = memo(({ assetKey }: { assetKey: AssetKey }) => {
  ...
  return (
    <div className="absolute inset-0 z-0 pointer-events-none">
      ...
      <div className="absolute inset-0 bg-[#1e0030]/40 z-10 mix-blend-overlay" />
      {/* High Contrast for Chrome feel */}
      <div
        ref={containerRef}
        className="w-full h-full opacity-50 grayscale-[10%] contrast-125 scale-110 will-change-transform"
      />
    </div>
  );
});
...
// --- 4. CUSTOM VIP HEADER WITH SHIMMER BUTTONS ---
const LiveChromeHeader = memo(({ 
  ...
  return (
    ...
    >
      {/* LEFT: Interactive Asset Buttons */}
            ...
            >
              ...
              <div className="flex flex-col items-start z-10">
                <span className={cn(
                  ...
                  isActive ? "animate-text-shimmer-vip" : "text-neutral-500"
                )}>
                  {asset.name}
                </span>
                {isActive && (
      ...
      <div className="flex flex-col items-end">
        <div className="text-2xl md:text-3xl font-mono font-black tracking-tight leading-none tabular-nums animate-text-shimmer-vip">
...
export const MultiStepLoaderVip = ({ loadingStates, loading }: { loadingStates: LoadingState[]; loading: boolean; }) => {
    ...
    <AnimatePresence mode="wait">
      {loading && (
        ...
        >
          ...
          <div className="absolute inset-0 bg-[radial-gradient(circle_at_center,rgba(59,7,100,0.3)_0%,#05010d_100%)] z-10 pointer-events-none" />
          ...
          <div className="relative z-20 flex flex-col items-center justify-center p-4 w-full h-full pb-24 md:pb-32 pointer-events-none">
            ...
            <div className="relative w-full max-w-[400px] flex flex-col items-center justify-center">
              ...
              <div className="relative z-30 flex flex-col items-center mb-6">
                <div className="text-6xl md:text-8xl font-mono font-bold mb-2 tabular-nums tracking-tighter animate-text-shimmer-vip">
