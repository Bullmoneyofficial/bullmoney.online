  ...
  ({ children, label, className = "", showShine = false, isXMUser = false }, ref) => {
    ...
    return (
      <motion.div
        ...
        className={cn(
          "flex flex-col h-full w-full items-center justify-center rounded-2xl shadow-lg transition-all duration-300 relative overflow-hidden group/icon icon-glass pointer-events-none",
          className
        )}
        style={{
          border: showShine 
